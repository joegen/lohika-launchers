...
var debug = require('debug')('launchers::kurento-room');
...
var DEFAULT_INPUT_FILE = path.join(__dirname,'../../test/kurento-room/files/input/kurento-room-demo.conf.json');
// default kurento installation config
var DEFAULT_OUTPUT_FILE = '/usr/local/lohika/kurento-room/kurento-room-demo-6.6.0/files/kurento-room-demo.conf.json';
