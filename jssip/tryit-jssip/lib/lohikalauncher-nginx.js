...
var Launcher = require('./lohikalauncher.js');
...
var DEFAULT_INPUT_FILE = path.join(__dirname,'/nginx/test/files/input/loadtest-nginx.conf.json');
// default kurento installation config
var DEFAULT_OUTPUT_FILE = path.join(__dirname,'/nginx/test/files/output/loadtest-nginx.conf');
