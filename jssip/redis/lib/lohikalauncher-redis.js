...
var debug = require('debug')('launchers::redis');
...
var DEFAULT_INPUT_FILE = path.join(__dirname,'conf/redis.conf.json');
// default kurento installation config
var DEFAULT_OUTPUT_FILE = path.join(__dirname,'/conf/redis.conf');
